...
HSplit::HSplit(View* top, View* bottom)
    : top(top), bottom(bottom), split_height(0), middle(true)
{ }
HSplit::HSplit(View* top, View* bottom, int split_height)
    : top(top), bottom(bottom), split_height(split_height), middle(false)
{ }
...
{
    if(this->middle)
        this->split_height = area->height/2;
...
VSplit::VSplit(View* left, View* right)
    : left(left), right(right), split_width(0), middle(true)
{ }
VSplit::VSplit(View* left, View* right, int split_width)
    : left(left), right(right), split_width(split_width), middle(false)
{ }
